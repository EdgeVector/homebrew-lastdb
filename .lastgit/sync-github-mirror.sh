#!/usr/bin/env bash
# Push LastGit main to the public GitHub Homebrew tap mirror.
...
export LASTGIT_MIRROR_CLONE="${LASTGIT_MIRROR_CLONE:-$HOME/.lastgit/mirror-clones/homebrew-lastdb}"
export LASTGIT_MIRROR_REMOTE_URL="${LASTGIT_MIRROR_REMOTE_URL:-https://github.com/EdgeVector/homebrew-lastdb.git}"
export LASTGIT_MIRROR_SOURCE_URL="${LASTGIT_MIRROR_SOURCE_URL:-lastdb:///homebrew-lastdb}"
...
MODE="${1:-}"
exec "$HOME/code/edgevector/lastgit/.lastgit/sync-github-mirror.sh" homebrew-lastdb "$MODE"

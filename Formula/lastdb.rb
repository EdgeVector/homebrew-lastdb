...
class Lastdb < Formula
  ...
  on_macos do
    ...
    url "https://github.com/EdgeVector/homebrew-lastdb/releases/download/v0.22.1/lastdb-aarch64-apple-darwin.tar.gz"
    sha256 "d7e94e0245d476aa9fe6e6a485148dd24be61c7fb793506f557cd3f3ec844e95"
  end

class FolddbDev < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/EdgeVector/homebrew-folddb/releases/download/folddb-dev-v0.3.0/folddb-dev-aarch64-apple-darwin.tar.gz"
      sha256 "7a96c2d017f75c0dc305607d436d6cbed0ee96dd9a608c736c501262421656bd"
    else
      url "https://github.com/EdgeVector/homebrew-folddb/releases/download/folddb-dev-v0.3.0/folddb-dev-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/EdgeVector/homebrew-folddb/releases/download/folddb-dev-v0.3.0/folddb-dev-x86_64-unknown-linux-gnu.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      Start here:
        folddb-dev --help
        https://github.com/EdgeVector/homebrew-folddb/releases/download/folddb-dev-v#{version}/developer-onboarding.md
